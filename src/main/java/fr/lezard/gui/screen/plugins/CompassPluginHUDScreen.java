...
public class CompassPluginHUDScreen extends Screen {
	...
	protected void init() {
		...
		this.addRenderableWidget(CycleButton.builder(CompassPluginHUD.SecondColor::getName).withValues(Arrays.asList(CompassPluginHUD.SecondColor.values())).withInitialValue(CompassPluginHUD.second).create(this.width / 2 - 48, this.height / 6 + 88, 96, 20, new TranslatableComponent(Lezard.NAMESPACE + ".secondColor"), (p_167441_, p_167442_) -> {
