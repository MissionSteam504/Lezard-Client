...
public class ArmorPluginHUDScreen extends Screen {
	...
	protected void init() {
		...
		this.addRenderableWidget(CycleButton.builder(ArmorPluginHUD.Modes::getName).withValues(Arrays.asList(ArmorPluginHUD.Modes.values())).withInitialValue(ArmorPluginHUD.currentMode).create(this.width / 2 - 48, this.height / 6 + 88, 96, 20, CommonLezardVariables.MODE, (p_167441_, p_167442_) -> {
