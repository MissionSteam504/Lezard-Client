...
public class FullBrightPluginScreen extends Screen {

	public FullBrightPluginScreen() {
		super(new TranslatableComponent(Lezard.NAMESPACE + ".plugin.fullbright"));
	}
	...
	protected void init() {
		Utils.normalPluginScreenInit(6, this, width, height);
	}
