...
public class ScoreboardPluginHUDScreen extends Screen {

	public ScoreboardPluginHUDScreen() {
		super(new TranslatableComponent(Lezard.NAMESPACE + ".plugin.score"));
	}
	...
	protected void init() {
		Utils.normalPluginHudScreenInit(13, this, width, height);
	}
