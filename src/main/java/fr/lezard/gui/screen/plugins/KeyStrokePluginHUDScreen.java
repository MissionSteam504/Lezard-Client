...
public class KeyStrokePluginHUDScreen extends Screen {
	...
	protected void init() {
		...
		this.addRenderableWidget(CycleButton.builder(KeyStrokeModule::getName).withValues(Arrays.asList(KeyStrokeModule.values())).withInitialValue(KeyStrokePluginHUD.keyMode).create(this.width / 2 - 48, this.height / 6 + 88, 96, 20, CommonLezardVariables.MODE, (p_167441_, p_167442_) -> {
