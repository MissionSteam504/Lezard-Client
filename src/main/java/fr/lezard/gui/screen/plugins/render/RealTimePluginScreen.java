...
public class RealTimePluginScreen extends Screen {

	public RealTimePluginScreen() {
		super(new TranslatableComponent(Lezard.NAMESPACE + ".plugin.realtime"));
	}
	
	protected void init() {
		Utils.normalPluginScreenInit(14, this, this.width, this.height);
	}
