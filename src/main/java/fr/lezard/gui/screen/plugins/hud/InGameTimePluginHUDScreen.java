...
public class InGameTimePluginHUDScreen extends Screen {

	public InGameTimePluginHUDScreen() {
		super(new TranslatableComponent(Lezard.NAMESPACE + ".plugin.igtime"));
	}
	...
	protected void init() {
		Utils.normalPluginHudScreenInit(7, this, width, height);
	}
