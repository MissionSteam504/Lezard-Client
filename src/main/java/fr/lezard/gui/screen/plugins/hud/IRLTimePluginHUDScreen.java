...
public class IRLTimePluginHUDScreen extends Screen {

	public IRLTimePluginHUDScreen() {
		super(new TranslatableComponent(Lezard.NAMESPACE + ".plugin.irl"));
	}
	...
	protected void init() {
		Utils.normalPluginHudScreenInit(8, this, width, height);
	}
